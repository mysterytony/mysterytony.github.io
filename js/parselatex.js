        ...
        if (!(window.MathJax && MathJax.Hub)) {
            ...
            (function(BASENAME) {
                ...
                var TESTEVAL = function() {
                    ...
                    if (window.__TeSt_VaR__) {
                        try { delete window.__TeSt_VaR__ } catch (error) { window.__TeSt_VaR__ = null }
                    } else {
            ...
            (function(e) {
                ...
                a.Ajax = {
                    ...
                    Load: function(k, m) {
                        ...
                        k = this.fileURL(k);
                        if (this.loading[k]) { this.addHook(k, m) } else {
                    ...
                    removeHook: function(i) {
                        if (this.loadHooks[i.file]) {
                            ...
                            if (!this.loadHooks[i.file].hooks.length) { delete this.loadHooks[i.file] }
                        }
                    },
                    Preloading: function() {
                        for (var l = 0, j = arguments.length; l < j; l++) {
                            var k = this.fileURL(arguments[l]);
                            if (!this.loading[k]) { this.loading[k] = { preloaded: true } }
                        }
                    },
                    loader: {
                        JS: function(k, m) {
                    ...
                    timer: {
                        ...
                        file: function(j, i) {
                            if (i < 0) { a.Ajax.loadTimeout(j) } else { a.Ajax.loadComplete(j) }
                        },
                        ...
                        checkSafari2: function(i, j, k) {
                            ...
                            if (document.styleSheets.length > j && document.styleSheets[j].cssRules && document.styleSheets[j].cssRules.length) { k(i.STATUS.OK) } else { setTimeout(i, i.delay) }
                        },
                        checkLength: function(i, l, n) {
                            ...
                            if (m) { setTimeout(a.Callback([n, i.STATUS.OK]), 0) } else { setTimeout(i, i.delay) }
                        }
                    },
                            ...
                            if (p === "{") {
                                ...
                                if (p >= "0" && p <= "9") {
                                    ...
                                    if (k) {
                                        if (k[1] === "plural") {
                                            var d = o[k[2] - 1];
                                            if (typeof d === "undefined") { f[j] = "???" } else {
                                                d = this.plural(d) - 1;
                                                var h = k[3].replace(/(^|[^%])(%%)*%\|/g, "$1$2%\uEFEF").split(/\|/);
                                                if (d >= 0 && d < h.length) { f[j] = this.processString(h[d].replace(/\uEFEF/g, "|"), o, g) } else { f[j] = "???" }
                                            }
                                        } else { f[j] = "%" + f[j] }
                                    }
                                }
                        ...
                        if (e[d] instanceof Array) {
                            ...
                            if (typeof f[1] === "string") {
                                ...
                                if (f[1] instanceof Array) { c = c.concat(this.processSnippet.apply(this, f)) } else {
                                    if (f.length >= 3) { c.push([f[0], f[1], this.processSnippet(g, f[2])]) } else { c.push(e[d]) }
                                }
                            }
                        } else { c.push(e[d]) }
                    }
            ...
            MathJax.Hub = {
                ...
                processMessage: function(d, b) {
                    ...
                    if (this.config.showProcessingMessages) { MathJax.Message.Set(c.concat(a), 0) }
                },
            ...
            MathJax.Hub.Startup = {
                ...
                onLoad: function() {
                    ...
                    if (window.addEventListener) {
                        ...
                        if (!this.params.noDOMContentEvent) { window.addEventListener("DOMContentLoaded", a, false) }
                    } else {
            ...
            (function(d) {
                ...
                b.OutputJax = g.Subclass({
                    ...
                    Remove: function(h) {}
                }, { id: "OutputJax", version: "2.6.0", directory: g.directory + "/output", extensionDir: g.extensionDir, fontDir: e + (b.isPacked ? "" : "/..") + "/fonts", imageDir: e + (b.isPacked ? "" : "/..") + "/images" });
                b.ElementJax = g.Subclass({
                    ...
                    Clone: function(h) {
                        ...
                        for (i in h) {
                            ...
                            if (typeof(this[i]) === "undefined" || (this[i] !== h[i] && i !== "inputID")) { this[i] = h[i] }
                        }
                    }
                }, {
                    id: "ElementJax",
            ...
            (function(o) {
                ...
                d.queue.Push(["Post", s.signal, "Begin"], ["Config", s], ["Cookie", s], ["Styles", s], ["Message", s], function() {
                    ...
                    return i.Push({})
                }, ["Menu", s], s.onLoad(), function() { MathJax.isReady = true }, ["Typeset", s], ["Hash", s], ["MenuZoom", s], ["Post", s.signal, "End"])
            })("MathJax")
        }
    };
}
